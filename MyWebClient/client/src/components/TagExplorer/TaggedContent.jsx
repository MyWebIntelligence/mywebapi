                        ...
                        {context.categorizeTaggedContent(tags).map((tag, i) => <li key={i}>
                            ...
                            <ul>
                                {tag.contents.map((content, j) => <li key={j}>
                                    <i className="fas fa-trash text-danger float-end ms-1"
                                       onClick={_ => deleteTaggedContent(content.id)}/>

                                    <i className="fas fa-edit text-primary float-end ms-1"
                                       onClick={_ => {
                                    ...
                                    {forLand === true &&
                                    <i className="fas fa-link float-end ms-1 text-primary" onClick={_ => {
